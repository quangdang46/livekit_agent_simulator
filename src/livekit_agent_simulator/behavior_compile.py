...
def compile_from_speech_conditions(persona: dict[str, Any]) -> list[ScriptStep]:
    ...
    # interruption_rate (none|low|medium|high) is a PARALLEL runner policy
    # (InterruptRateRunner in run_orchestrator) — NOT compiled ScriptSteps.
    # Validation happens in apply_caller_behavior via parse_interrupt_rate.
